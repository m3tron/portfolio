...
const stackList = {
  react: {
    ...
    icon: <ReactJs title="React" color="#61DAFB" />,
  },
  nextjs: {
    href: "https://nextjs.org",
    icon: <Nextdotjs title="Next.js" color="#000000" />,
  },
  css: {
    href: "https://w3.org",
    icon: <CssThree title="CSS3" color="#1572B6" />,
  },
  tailwindcss: {
    href: "https://tailwindcss.com",
    icon: <Tailwindcss title="Tailwindcss" color="#06B6D4" />,
  },
  bulma: {
    href: "https://bulma.io",
    icon: <Bulma title="Bulma" color="#00D1B2" />,
  },
  nodejs: {
    href: "https://nodejs.org",
    icon: <Nodedotjs title="Node.js" color="#339933" />,
  },
  mongodb: {
    href: "https://mongodb.com",
    icon: <Mongodb title="MongoDB" color="#47A248" />,
  },
  docker: {
    href: "https://docker.com",
    icon: <Docker title="Docker" color="#2496ED" />,
  },
  kubernetes: {
    href: "https://kubernetes.io",
    icon: <Kubernetes title="Kubernetes" color="#326CE5" />,
  },
  styledcomponents: {
    href: "https://styled-components.com",
    icon: <Styledcomponents title="Styled-components" color="#DB7093" />,
  },
  chartjs: {
    href: "https://chartjs.org",
    icon: <Chartdotjs title="Chart.js" color="#FF6384" />,
  },
};
